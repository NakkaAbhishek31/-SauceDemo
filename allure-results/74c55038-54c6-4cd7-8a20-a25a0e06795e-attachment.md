...
- Name: Inventory.spec.ts >> Cart combines products added from Products page and Details page
- Location: tests\Inventory.spec.ts:490:6
...
> 108 |   await this.addToCartFromDetailsPage.click()
  ...
  118 | }
  119 | 
  120 | productDescription(productName: string): Locator {
  121 |   return this.productCard(productName).locator('.inventory_item_desc');
  122 | }
  123 | 
  124 | }
  125 | 
